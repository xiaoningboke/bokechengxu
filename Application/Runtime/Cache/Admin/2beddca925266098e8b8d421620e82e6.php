...
<body>
    ...
    <form class="layui-form" id="form" action="<?php echo U('Admin/Index/doExitArticle');?>" method="post">
        <input type="hidden" name="id" value="<?php echo ($data["id"]); ?>">
        <div class="layui-form-item">
            <label class="layui-form-label">文章标题</label>
            <div class="layui-input-block">
                <input type="text" name="title" lay-verify="title" autocomplete="off" placeholder="请输入文章标题" class="layui-input" value="<?php echo ($data["title"]); ?>">
            </div>
        </div>
         <div class="layui-form-item">
