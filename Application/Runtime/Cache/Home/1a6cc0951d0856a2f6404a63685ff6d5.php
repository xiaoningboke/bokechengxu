    ...
    <div class="content">
        ...
        <div class="main">
            ...
            <div class="item">
                ...
                <div class="aboutAticle">
                    <h1>评论列表</h1>
                    <ul>
                        <?php if(is_array($commentData)): foreach($commentData as $key=>$vo): ?><li><?php echo ($vo["content"]); ?> -- (<?php echo ($vo["date"]); ?>)</li><?php endforeach; endif; ?>
                    </ul>
                </div>
                <div class = "leaveMassage">
                    <h1>发表留言</h1>
                    <form action="<?php echo U('Home/Index/comment');?>" method="post" accept-charset="utf-8">
